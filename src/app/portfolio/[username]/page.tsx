...
const ModernPortfolioPage = ({ params }: PageProps) => {
  ...
  // Social links from user data with platform/URL mapping
  ...
  // Use API-provided socialLinks if available, otherwise build from individual fields
  const socialLinks = user?.socialLinks && user.socialLinks.length > 0
    ...
    : [
        { icon: FaGithub, url: user?.github_url || (user?.github_username ? `https://github.com/${user?.github_username}` : undefined), label: 'GitHub' },
        { icon: FaLinkedin, url: user?.linkedin || undefined, label: 'LinkedIn' },
        { icon: FaTwitter, url: user?.twitter || undefined, label: 'Twitter' },
        { icon: FaInstagram, url: user?.instagram || undefined, label: 'Instagram' },
        { icon: FaFacebook, url: user?.facebook || undefined, label: 'Facebook' },
        { icon: FaYoutube, url: user?.youtube || undefined, label: 'YouTube' },
        { icon: FaBehance, url: user?.behance || undefined, label: 'Behance' },
        { icon: FaDribbble, url: user?.dribbble || undefined, label: 'Dribbble' },
              ...
              <Card bg={cardBg} p={8} borderRadius="2xl" shadow="lg" maxW="2xl" mx="auto">
                <VStack spacing={6}>
                  ...
                  <VStack spacing={4}>
                    ...
                    {user.website && (
                      <HStack spacing={4} w="full" justify="center">
                        <FaExternalLinkAlt color={accentColor} />
                        <Link href={user.website} target="_blank" color={accentColor} fontWeight="medium">
